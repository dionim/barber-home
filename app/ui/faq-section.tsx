  ...
  return (
    <>
      <SectionTitle
        ...
        title={content.body.faqSection.title}
        description={content.body.faqSection.description}
      />
      ...
      >
        ...
        >
          <Stack display={{ base: 'none', md: 'flex' }}>
            ...
            <Text
              ...
              fontWeight="bold"
            >
              {content.body.faqSection.description}
            </Text>
          </Stack>
          <Flex
            gap="2"
            ...
            alignItems="center"
            onClick={() =>
              window.open(content.body.faqSection.emailButton, '_blank')
            }
          >
          ...
          <Flex gap="3" mt={{ base: 7, md: 0 }}>
            <IconButton
              ...
              size="md"
              onClick={() =>
                window.open(content.body.faqSection.instagramButton, '_blank')
              }
            >
              {/* Instagram */}
              <svg
            ...
            <IconButton
              ...
              borderRadius="lg"
              onClick={() =>
                window.open(content.body.faqSection.linkedinButton, '_blank')
              }
            >
              {/* LinkedIn */}
              <svg
        ...
        >
          {content.body.faqSection.faqs.map((question) => (
            <Collapsible.Root
              key={question.id}
              marginTop="-0.5rem"
